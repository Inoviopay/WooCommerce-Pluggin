<?php
/**
 * Inovio ACH Payment Method Blocks Support
 *
 * Provides WooCommerce Blocks integration for the Inovio ACH payment gateway.
 *
...
/**
 * Inovio ACH Blocks Support Class
 *
 * Extends AbstractPaymentMethodType to provide WooCommerce Blocks compatibility
 * for the Inovio ACH payment gateway.
 */
final class WC_Ach_Inovio_Blocks_Support extends AbstractPaymentMethodType {
     ...
     * @var string
     */
    protected $name = 'achinoviomethod';

    /**
     * Instance of the payment gateway
     *
     * @var Woocommerce_Ach_Inovio_Gateway
     */
    private $gateway;
    ...
    public function initialize() {
        ...
        $this->settings = get_option( 'woocommerce_achinoviomethod_settings', [] );
    ...
    public function get_payment_method_script_handles() {
        ...
        wp_register_script(
            'wc-ach-inovio-blocks-integration',
            $script_url,
        ...
        return [ 'wc-ach-inovio-blocks-integration' ];
    }
